...
const Currentinfo = () => {
  return (
    <div
      className="bg-white p-16 rounded-lg shadow-lg border-4 mx-auto"
      style={{
        borderColor: "#E09512",
        maxWidth: "95%", 
        minHeight: "600px", 
    ...
    >
      ...
      <div className="grid grid-cols-4 gap-10 mb-16">
        ...
        <div
          className="text-white px-10 py-8 rounded-lg shadow-lg"
          style={{ backgroundColor: "#012D47" }}
        >
